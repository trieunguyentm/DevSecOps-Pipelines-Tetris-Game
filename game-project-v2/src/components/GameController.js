...
const GameController = () => {
  ...
  const { displayBoard, board, resetBoard, isGameOver } = useBoard(
    player,
    addLines,
    spawnNextPiece,
  );
  ...
  const speed =
    gameState === "playing" ? LEVEL_SPEEDS[stats.level] || 100 : null;
        ...
        <div className="overlay">
          <div className="overlay-content">
            ...
            <p className="overlay-text">
              Enhanced Edition — Hold, Combos & High Score
            </p>
      ...
      return (
        <div className="overlay overlay-gameover">
          <div className="overlay-content">
            ...
            <p className="final-score">
              Level: {stats.level} — Lines: {stats.lines}
            </p>
    ...
    <div className="game-container">
      <div className="game-left-panel">
        ...
        <div className="controls-info">
          ...
          <div className="control-item">
            <span className="key">C</span> Hold
          </div>
          <div className="control-item">
